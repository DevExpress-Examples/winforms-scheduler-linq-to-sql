...
namespace XtraScheduler_linq
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="XtraCars")]
	...
	public partial class DBResource
	{
		...
		[Column(Storage="_Trademark", DbType="NVarChar(50)")]
		...
		[Column(Storage="_HP", DbType="SmallInt")]
		...
		[Column(Storage="_Liter", DbType="Float")]
		...
		[Column(Storage="_Cyl", DbType="TinyInt")]
		...
		[Column(Storage="_TransmissSpeedCount", DbType="TinyInt")]
		...
		[Column(Storage="_TransmissAutomatic", DbType="NVarChar(3)")]
		...
		[Column(Storage="_MPG_City", DbType="TinyInt")]
		...
		[Column(Storage="_MPG_Highway", DbType="TinyInt")]
		...
		[Column(Storage="_Category", DbType="NVarChar(7)")]
		...
		[Column(Storage="_Hyperlink", DbType="NVarChar(50)")]
		...
		[Column(Storage="_RtfContent", DbType="NVarChar(MAX)")]
    ...
    partial void OnCarIdChanged();
		...
		[Column(Storage="_CarIdShared", DbType="NVarChar(MAX)")]
